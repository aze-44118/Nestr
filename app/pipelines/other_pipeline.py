    ...
    async def generate_podcast(
        ...
        try:
            ...
            script = await self._generate_script(
                ...
                message=message,
                lang=lang,
                estimated_duration=metadata.get("estimated_duration_sec", 240)  # Durée moyenne
            )
            ...
            return {
                "status": "error",
                "message": metadata.get("messages", {}).get("error", {}).get(lang, "Erreur lors de la génération du podcast créatif")
            }
